...
describe('consistent-evaluation-feedback-new-editor', () => {

	const visualDiff = new VisualDiff('consistent-evaluation-feedback-new-editor', __dirname);
	...
	before(async() => {
		...
		await page.goto(`${visualDiff.getBaseUrl()}/test/perceptual/consistent-evaluation-feedback-new-editor.visual-diff.html`, { waitUntil: ['networkidle0', 'load'] });
